...
config :cuevolution, CuevolutionWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "aVnMktdiBiYYuFBMOhMbQ0HXB4qnqPtUExBEbgMl+/HON37Jtv0JMtgNTfor7vLm",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:cuevolution, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:cuevolution, ~w(--watch)]}
  ]
...
config :cuevolution, CuevolutionWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/cuevolution_web/router\.ex$",
      ~r"lib/cuevolution_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :cuevolution, dev_routes: true
...
config :cuevolution, :twilio, from: System.get_env("TWILIO_FROM_NUMBER")
