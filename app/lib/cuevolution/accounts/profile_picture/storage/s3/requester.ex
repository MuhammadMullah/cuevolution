defmodule Cuevolution.Accounts.ProfilePicture.Storage.S3.Requester do
  ...
  `Req`, which `AfricasTalkingAdapter` stubs via `Req.Test`). Swapping
  this module via `config :cuevolution, :s3_requester` is what lets
  `Storage.S3`'s tests Mox-mock the network boundary.
